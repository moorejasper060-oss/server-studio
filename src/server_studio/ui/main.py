...
from server_studio.app import build_server_manager, build_content_services, build_sharing_factory
...
def make_window(manager, paths: AppPaths, apply_theme,
                content_manager=None, search_client=None, sharing_factory=None) -> MainWindow:
    ...
    return MainWindow(manager=manager, paths=paths, apply_theme=apply_theme,
                      ...
                      sharing_factory=sharing_factory)
